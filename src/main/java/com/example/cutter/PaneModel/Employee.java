...
import com.example.cutter.Logic.Crypto;
...
public class Employee {
    ...
    public static Pane getPane(ScrollPane scrollPane, boolean fl, boolean fl2, boolean fl3) throws SQLException, FileNotFoundException, ClassNotFoundException {
        Pane res = new Pane();
        ////fl2 - аналитик
        ...
        if(Front.theme==0){
            ...
            sal.setFill(Color.WHITE);
            exp.setFill(Color.WHITE);
    ...
    public static Pane getPane2(ScrollPane scrollPane, boolean fl, boolean fl2, boolean fl3) throws SQLException, FileNotFoundException, ClassNotFoundException {
        Pane res = new Pane();
        ////fl2 - аналитик
        ////fl - можно ли редачить
        ////fl3 - админ
        ...
        for(int i=0; i<mas.length;i++, u+=70){
            ...
            del.setOnAction(r -> {
                try {
                    ...
                    Pane pane = Employee.getPane2(scrollPane,true,true,true);
    ...
    public static void change(String id,  ScrollPane scrollPane, boolean flagAdmin) throws SQLException, FileNotFoundException, ClassNotFoundException {
        ...
        if(flagAdmin) {
            if (Front.theme == 1)
                Url = new FileInputStream("png/editStaffAdmin_day.png");
            else
                Url = new FileInputStream("png/editStaffAdmin_night.png");
        }
        else {
            if (Front.theme == 1)
                Url = new FileInputStream("png/editStaff_day.png");
            else
                Url = new FileInputStream("png/editStaff_night.png");
        }
        Image url = new Image(Url);
        ...
        if(Front.theme==0){
            ...
            sal.setStyle("-fx-text-fill: white;");
            inf.setStyle("-fx-text-fill: white;");
        ...
        save.setOnAction(x ->{
            ...
            try {
                ...
                Pane p = Employee.getPane(scrollPane,true, false, flagAdmin);
    ...
    public static void addEmployee(ScrollPane scrollPane) throws FileNotFoundException {
        Group root_add = new Group();
        ...
        FileInputStream Url;
        if(Front.theme ==1)
            Url = new FileInputStream("png/addStaff_day.png");
        else
            Url = new FileInputStream("png/addStaff_night.png");
        Image url = new Image(Url);
        ImageView front = new ImageView(url);
        front.setX(0);
        front.setY(0);
        ...
        save.setOnAction(x ->{
            ...
            if(!t1.isEmpty()&&!t2.isEmpty()&&!t3.isEmpty()&&!t4.isEmpty()&&!t6.isEmpty()&&!t7.isEmpty()&&
                ...
                try {
                    ...
                    Pane p = Employee.getPane(scrollPane, true,false, true);
                    scrollPane.setContent(p);
                } catch (SQLException ex) {
                    throw new RuntimeException(ex);
                } catch (FileNotFoundException e) {
