...
public class Structure {
    ...
    public static void change(String id,  ScrollPane scrollPane) throws SQLException, FileNotFoundException, ClassNotFoundException {
        ...
        FileInputStream Url;
        if(Front.theme ==1)
            Url = new FileInputStream("png/editStructureLocal_day.png");
        else
            Url = new FileInputStream("png/editStructureLocal_night.png");
        Image url = new Image(Url);
        ...
        if(Front.theme==0){
            ...
            kol_empl.setStyle("-fx-text-fill: white;");
            address.setStyle("-fx-text-fill: white;");
            num.setStyle("-fx-text-fill: white;");
            post.setStyle("-fx-text-fill: white;");
        ...
        save.setOnAction(x ->{
            ...
            if(check(t1,t2,t4,t5,t6)) {
                try {
                    ...
                    Pane p = Structure.getPane(scrollPane,true);
    ...
    public static void addStructure(ScrollPane scrollPane) throws FileNotFoundException {
        Group root_add = new Group();
        Scene scene_add = new Scene(root_add, 410, 410);
        Stage newWindow = new Stage();
        newWindow.initStyle(StageStyle.DECORATED);
        ...
        FileInputStream Url;
        if(Front.theme ==1)
            Url = new FileInputStream("png/addStructure_day.png");
        else
            Url = new FileInputStream("png/addStructure_night.png");
        Image url = new Image(Url);
        ImageView front = new ImageView(url);
        front.setX(0);
        front.setY(0);
