...
public class Client {
    ...
    public static Pane getPane(ScrollPane scrollPane, boolean fl, boolean fl2, boolean flagStaff) throws SQLException, FileNotFoundException, ClassNotFoundException {
        Pane res = new Pane();
        ...
        for (int i = 0; i < mas.length; i++, u += 70) {
            ...
            if(fl2) {
                ...
                pos.setOnAction(val -> {
                    try {
                        add_pos(scrollPane, id,flagStaff);
        ...
        find.setOnAction(value -> {
            ...
            try {
                ...
                print(scrollPane, client,fl, fl2, flagStaff);
            } catch (SQLException | FileNotFoundException e) {
                throw new RuntimeException(e);
            }
    ...
    public static void change(String id, ScrollPane scrollPane, boolean flag ) throws SQLException, FileNotFoundException {
        ...
        if(flag) {
            if (Front.theme == 1)
                Url = new FileInputStream("png/editClient_day.png");
            else
                Url = new FileInputStream("png/editClient_night.png");
        }
        else{
            if (Front.theme == 1)
                Url = new FileInputStream("png/editClientStaff_day.png");
            else
                Url = new FileInputStream("png/editClientStaff_night.png");
        }
        Image url = new Image(Url);
        ...
        if(Front.theme==0){
            ...
            bonus.setStyle("-fx-text-fill: white;");
        }
        ...
        save.setOnAction(x -> {
            ...
            if (t1.isEmpty())
                ...
                try {
                    ...
                    Pane p = Client.getPane(scrollPane, true, true,flag);
    ...
    public static void addClient(ScrollPane scrollPane, boolean fla, boolean flagStaff) throws SQLException, FileNotFoundException {
        Group root_add = new Group();
        ...
        FileInputStream Url;
        if(Front.theme ==1)
            Url = new FileInputStream("png/addClient_day.png");
        else
            Url = new FileInputStream("png/addClient_night.png");
        Image url = new Image(Url);
        ImageView front = new ImageView(url);
        front.setX(0);
        front.setY(0);
        ...
        save.setOnAction(x -> {
            ...
            if (t1.isEmpty())
                ...
                try {
                    ...
                    Pane p = Client.getPane(scrollPane, fla, true, flagStaff);
                    scrollPane.setContent(p);
                } catch (SQLException ex) {
                    throw new RuntimeException(ex);
                } catch (FileNotFoundException e) {
    ...
    public static void add_pos(ScrollPane scrollPane, String id, boolean flagStaff) throws SQLException, FileNotFoundException, ClassNotFoundException {
        Group root_add = new Group();
        ...
        FileInputStream Url;
        if(Front.theme ==1)
            Url = new FileInputStream("png/addVisit_day.png");
        else
            Url = new FileInputStream("png/addVisit_night.png");
        Image url = new Image(Url);
        ImageView front = new ImageView(url);
        front.setX(0);
        front.setY(0);
        ...
        save.setOnAction(x ->{
            ...
            if(chechPos(t4,t6)) {
                ...
                try {
                    ...
                    Pane p = Visit.getPane(scrollPane, flagStaff);
                    scrollPane.setContent(p);
                } catch (SQLException ex) {
                    throw new RuntimeException(ex);
                } catch (FileNotFoundException e1) {
    ...
    public static void print(ScrollPane scrollPane, Client[] mas, boolean fla, boolean fla2, boolean flagStaff) throws SQLException, FileNotFoundException {
        Pane res = new Pane();
        ...
        for (int i = 0; i < mas.length; i++, u += 70) {
            ...
            edit.setOnAction(t -> {
                try {
                    change(id, scrollPane,flagStaff);
            ...
            res.getChildren().addAll(name_text, id_text, status_text, bonus_text, pos);

            scrollPane.setContent(res);
            back.setOnAction(value -> {
                Pane pane1 = new Pane();
                try {
                    pane1 = Client.getPane(scrollPane, fla, fla2,false);
            ...
            find.setOnAction(value -> {
                ...
                try {
                    print(scrollPane, client, fla,fla2,flagStaff);
                } catch (SQLException e) {
                    throw new RuntimeException(e);
                } catch (FileNotFoundException e) {
                    throw new RuntimeException(e);
