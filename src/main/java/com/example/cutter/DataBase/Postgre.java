package com.example.cutter.DataBase;
...
public class Postgre {
    ...
    public Postgre(String login, String pass) throws SQLException {
        data_connection = DriverManager.getConnection("jdbc:postgresql://localhost:5432/Salon",login,pass);
        data_statmt = data_connection.createStatement();
        connection = DriverManager.getConnection("jdbc:postgresql://localhost:5432/Salon","postgres","123");
